...
function introType(){
    setTimeout(function(){
        introTitle.append("그는 ");
    },800);
    setTimeout(function(){
        introTitle.append("꺽꺽대며 ");
    },1300);
    setTimeout(function(){
        introTitle.append("자꾸 ");
    },1600);
    setTimeout(function(){
        introTitle.append("습관처럼 ");
    },2000);
    setTimeout(function(){
        introTitle.append("거짓말을 하는 ");
    },2200);
    setTimeout(function(){
        introTitle.append("자신이 ");
    },2600);
    setTimeout(function(){
        introTitle.append("혐오");
    },2900);
    setTimeout(function(){
        introTitle.append("스");
    },3200);
    setTimeout(function(){
        introTitle.append("럽다");
    },3400);
    setTimeout(function(){
        introTitle.append("고 ");
    },3600);
    setTimeout(function(){
        introTitle.append("이야기");
    },4000);
    setTimeout(function(){
        introTitle.append("했다.");
    },4200);
    setTimeout(function(){
        introTitle.append("\n");
    ...
    setTimeout(function(){
        introTitle.append("물론 ");
    },5000);
    setTimeout(function(){
        introTitle.append("거짓말");
    },5600);
    setTimeout(function(){
        introTitle.append("이");
    },6100);
